  ...
  const articles = [
    {
      ...
      content: (
        <>
          ...
          <p>In many ways, this journal is my first attempt to reconnect with writing. I’ve read that AI ranks at the 80th percentile of human creativity. That idea stuck with me, not because I see AI as a replacement for creativity, but because I wondered what it might unlock in someone like me. The world has already plenty of ways to make AI more public - through mass applications, products and everyday use. What I want to explore instead is how AI can be used in more private and introspective ways. This co-written journal is a baby step for that.</p>
